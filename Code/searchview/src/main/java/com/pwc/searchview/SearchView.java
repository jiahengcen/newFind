...
public class SearchView extends LinearLayout {
    ...
    private static final int SEARCH_ADAPTER = 1;
    private static final int COMPANY_ADAPTER = 2;
    private OnCompanyItemClickListener onItemClickListener;
    ...
    private void init() {
        ...
        et_search.setOnKeyListener(new View.OnKeyListener() {
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if (keyCode == KeyEvent.KEYCODE_ENTER && event.getAction() == KeyEvent.ACTION_DOWN) {
                    ...
                    boolean hasData = hasData(searchText);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (mAdapterType == SEARCH_ADAPTER) {
    ...
    private void searchCompany(String searchText) {
    ...
    public void setCompanyOnItemClickListener(OnCompanyItemClickListener listener) {
        onItemClickListener = listener;
    }

    public interface OnCompanyItemClickListener {
        void onItemClick(AdapterView<?> parent, View view, int position, long id, CompanyTitleListBean.CompanyTitleSubBean bean);
    }

    public void setCompanyAdapter(ListAdapter adapter) {
        mAdapterType = COMPANY_ADAPTER;
        listView.setAdapter(adapter);
    }

    public void setSearAdapter(ListAdapter adapter) {
        mAdapterType = SEARCH_ADAPTER;
        listView.setAdapter(adapter);
    }
